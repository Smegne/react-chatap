    ...
    <div className="chat">
      <div className="top">
        <div className="user">
          ...
          <div className="texts">
            ...
            <p>{isCurrentUserBlocked || isRecieverBlocked ? "You can't send a message" : "Hey, how are you?"}</p>
          </div>
        </div>
        <div className="icons">
      ...
      <div className="center">
        {chat?.messages?.map((message) => (
          <div className={`message ${message.senderId === currentUser.id ? "own" : ""}`} key={message.createAt}>
            <div className="texts">
